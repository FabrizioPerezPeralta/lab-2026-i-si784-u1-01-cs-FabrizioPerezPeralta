[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/eDlSD0I2)
[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-2972f46106e565e64193e422d61a12cf1da4916b45550586e14ef0a7c637dd04.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=23622823)
...
Se ha creado y configurado correctamente el entorno de la aplicación, definiendo `BankAccount` e incluyendo el método de prueba `Credit_WithValidAmount_UpdatesBalance` dentro de la clase `BankAccountTests.cs`. Las pruebas pasan con éxito en el workflow local.

### 2. Captura de Cobertura en SonarCloud
*(Asegúrate de colocar tu imagen `cobertura.png` en la raíz del proyecto para que se visualice correctamente la evidencia).*
![Cobertura SonarCloud](cobertura.png)

### 3. y 4. Automatización NuGet y Release
Se añadió el workflow en `.github/workflows/nuget.yml`, el cual se encarga de:
- Compilar y empaquetar (`dotnet pack`) la biblioteca `Bank.Domain`.
- Publicar el archivo `.nupkg` en GitHub Packages configurando el `source-url`.
- Crear automáticamente un Release versión `1.0.0` utilizando la acción de `softprops/action-gh-release@v1` incluyendo el registro de cambios (release notes).
